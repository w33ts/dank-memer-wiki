...
The Dank Memer blogs site contains a lot of useful blogs regarding past updates, as well as general blogs with more info regarding the bot and its growth and development. All the blogs can be found <a href="https://dankmemer.lol/blogs" target="_blank">here</a>.
...
|:------:|:------:|
| <a href="https://dankmemer.lol/blog/alpha-testing-is-important" target="_blank">Alpha Testing</a> | Learn about Dank Memer's Alpha Testers and what they do, how alpha testing works, and how testing helps the bot. |
...
| <a href="https://dankmemer.lol/blog/death" target="_blank">Death</a> | Learn about the risk of dying on the bot, what happens when you die and how can you prevent yourself from dying?
  | <a href="https://dankmemer.lol/blog/fishing-is-here" target="_blank">Fishing Overhaul</a> | Learn about the <a href="/Bot-features/Currency-Commands/Grind-Commands/Fishing" target="_blank">fishing</a> overhaul and why the command was changed.|
  | <a href="https://dankmemer.lol/blog/flows-update" target="_blank">Flows</a> | Learn about <a href="/Bot-features/Utility-and-Config-Commands/Config-Commands#Flow" target="_blank">flows</a>, why they were added, and how they help users run commands easier than ever.|
| <a href="https://dankmemer.lol/blog/gambling-removal" target="_blank">Gambling Removal</a> | Learn why Dank Memer removed gambling commands from the bot.|
| <a href="https://dankmemer.lol/blog/how-to-appeal" target="_blank">How to Appeal</a> | A special blog written by Kable, one of Dank Memer's bot admins. It explains how the <a href="/Resources/Reports-and-appeals#Appeals" target="_blank">appeal</a> process works and what makes a good appeal. |
| <a href="https://dankmemer.lol/blog/new-way-to-trade" target="_blank">New Way to Trade</a> | Learn how to trade with the <a href="/Bot-features/Currency-Commands/Market" target="_blank">/market</a> system and more about the <a href="/Bot-features/Currency-Commands/Friends" target="_blank">/friend</a> system. |
| <a href="https://dankmemer.lol/blog/report-redux" target="_blank">Report Redux</a> | A special blog written by Kable, one of Dank Memer's bot admins. It explains more about how to <a href="/Resources/Reports-and-appeals" target="_blank">report</a> rule breakers and what the <a href="/About-Dank-Memer/Bot-rules" target="_blank">bot rules</a> mean. |
| <a href="https://dankmemer.lol/blog/rewrite-changelog" target="_blank">Rewrite changelog</a> | In 2022, Dank Memer was completely rewritten to move from 'pls' commands to slash commands. This rewrite changelog goes over all the major changes the rewrite brought to help users transition. |
...
|<a href="https://dankmemer.lol/blog/skin-release" target="_blank">Skins</a>| Learn about Dank Memer's <a href="/Bot-features/Currency-Commands/Skins" target="_blank">skins</a> and why they were added.|
