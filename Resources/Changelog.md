...
## Changelog
All of the newest bot changes are reported in a public changelog users can access for the latest news. It contains everything you should know about current updates and what has changed in the past few months.
...
## Bot Maintenance
Whether it is a new feature update or changes on the back-end side of the bot, maintenance is important so that these updates can be pushed. Bot Maintenance can last 5 minutes or even a couple of hours!

During a maintenance, you cannot use any Dank Memer commands nor interact with any components. If you try to do so, you'll be met with a message similar to the one shown in the image below. By default, streaks are not frozen. This is because maintenance usually does not last that long to the point where it should affect your streaks however, in the rare occurrence that a maintenance has to last multiple days, your streaks will most likely be frozen.
...
![bot_maintenance.png](/resources/changelog/bot_maintenance.png)
