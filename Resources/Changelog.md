...
## Changelog
Most of the newest bot changes are reported in a public changelog users can access for the latest news. It contains everything you should know about current updates and is a good place to see what has changed in the past few months.

The changelog can be found on <a href="https://dankmemer.lol/changelog" target="_blank">Dank Memer's website</a>.

Each changelog has a number title, for example, "2023.17.0". This format shows the "Year.Week.UpdateNumber" (starts at 0), so you can easily find an update from a specific date.

For major updates and changes, the bot developers usually issue an <a href="/Bot-features/Utility-and-Config-Commands/Config-Commands#Alert" target="_blank">alert</a> so that when you run commands, you receive a message. If you want to be notified when any new changelog is released, big or small, enable the new changelog notifications in <a href="/Bot-features/Utility-and-Config-Commands/Config-Commands#Settings" target="_blank">/settings</a> under the ephemeral notifications option.

## Bot Maintenance
Whether it is a new feature update or changes on the back-end side of the bot, maintenance is important so that these updates can be pushed. Bot Maintenance can last 5 minutes or even a couple of hours! Before maintenance begins, there will often be a 5 minute warning to help minimize wasting items or boosts you might be about to purchase.

<br>
<center>
  <img src="/resources/changelog/botmaintenance_warning.png" alt="Fish catch." width=250>
</center>

During a maintenance, you cannot use any Dank Memer commands nor interact with any components. If you try to do so, you'll be met with a message similar to the one shown in the image below. 

<br>
<center>
  <img src="/resources/changelog/botmaintenance_new.png" alt="Fish catch." width=450>
</center>

By default, streaks are not frozen. This is because maintenance usually does not last long enough to affect your streaks. In the rare occurrence that a maintenance has to last several hours or days, the developers usually preserve streaks, pets, marriages, etc., so users do not lose progress.

If a scheduled maintenance is planned to last a few hours, it will be announced in the <a href="https://discord.gg/dankmemerbot" target="_blank">Dank Memer Support Server</a> and will most likely also be shown on the <a href="https://dankmemer.wiki/Bot-features/Utility-and-Config-Commands/Config-Commands#Alert" target="_blank">/alert</a> command to ensure users are prepared for it.
