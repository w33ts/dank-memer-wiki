...
|:--------:|:------:|:--------------:|:------:|:--------------:|:--------------:|:-----------------:|:-----------------:|
| **Boxed Chocolates** {: #BoxedChocolates} | <img src="/items/consumables/boxedchocolates.png" alt="Boxed Chocolates" width="50" height="50"> | 40  | A Valentine's Day <a href="/Items/Drops" target="_blank">drop</a> item. Can be used to increase your marriage level by three levels. | Yes | <a href="/Bot-features/Currency-Commands/Market" target="_blank">Market</a> | No  | <a href="https://dankmemer.wiki/en/Bot-features/Currency-Commands/Skins#BoxedChocolatesSkin" target="_blank">Yes</a> | 
...
| **Fart in a Bottle** {: #FartinaBottle} |  <img src="/items/consumables/fartinabottle.png" alt="Fart in a Bottle" width="50" height="50"> | 32 |  A drop item used to stop a person from running commands for one hour, but can also backfire on the user.    |   Yes  |   <a href="/Bot-features/Currency-Commands/Market" target="_blank">Market</a>  | No | No |
...
| **Sugar Skull** {: #SugarSkull} |  <img src="/items/consumables/sugarskull.png" alt="Sugar Skull" width="50" height="50">  |   34 |  A Halloween drop item. Can be used to turn your embed colors white.    |  Yes |  <a href="/Bot-features/Currency-Commands/Market" target="_blank">Market</a> | No | No |
