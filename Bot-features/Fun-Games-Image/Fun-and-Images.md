...
Want to take a break from the currency aspect of the bot? No problem! Dank Memer has a few non-currency commands to have fun with. 
- [8ball](/Bot-features/Fun-Games-Image/Fun-and-Images#Ball)
- [Animals](/Bot-features/Fun-Games-Image/Fun-and-Images#Animals)
- [Clap](/Bot-features/Fun-Games-Image/Fun-and-Images#Clap)
- [Compare](/Bot-features/Fun-Games-Image/Fun-and-Images#Compare)
- [Image](/Bot-features/Fun-Games-Image/Fun-and-Images#Image)
- [Meme](/Bot-features/Fun-Games-Image/Fun-and-Images#Meme)
- [Rate](/Bot-features/Fun-Games-Image/Fun-and-Images#Rate)
- [Trivia](/Bot-features/Fun-Games-Image/Fun-and-Images#Trivia)
- [Xkcd](/Bot-features/Fun-Games-Image/Fun-and-Images#Xkcd)

## 8ball {: #Ball}
Using the `/8ball` command lets you ask questions to which the bot will reply with some funny answers.
<br>
<center>
<img src="/bot-features/misc-fun/8ball.png" alt="8ball results.">
</center>

## Animals {: #Animals}
Using the `/animals` command makes the bot post a picture based on one of the following types:
- All (any type of animal)
- Aww
- Ducc
- Foxxy
- Ferrets
...
<br>
<center>
<img src="/bot-features/misc-fun/animals.png" alt="animals command">
</center>

## Clap {: #Clap}
Using the `/clap` command lets you input text, and the bot will respond to it with clapping hand emojis between the words.
<br>
<center>
<img src="/bot-features/misc-fun/claps.png" alt="clap command">
</center>


## Compare {: #Compare}
Using the `/compare` command makes the bot compare your stats to another user of your choice. The following stats are compared:
- Level
- Prestige
- Omega
- Commands Issued
...
<br>
<center>
<img src="/bot-features/misc-fun/compare.png" alt="Compare command">
</center>


## Image {: #Image}
You can use the `/image` command to post various images or to alter people's profiles. The available image commands include:
- Changemymind
- Communism
- Crabrave
- Deepfry
...
Once you selected a type, you can input text or pick the user's profile you want to alter.
<br>
<center>
<img src="/bot-features/misc-fun/image.png" alt="image options">
</center>


## Meme {: #Meme}
Using the `/meme` command will post a meme. The available types of memes are:
- Blacktwitter
- Comics
- Facepalm
- Meirl
...
## Rate {: #Rate}
Using the `/rate` command will let you "rate" yourself and others in various ways. The results are random and intended to be fun, but some users use them to compete with others.
The `/rate` options are in the image below.

<br>
<center>
<img src="/bot-features/misc-fun/rate.png" alt="rate options are peepee, dank, epicgamer, gay, simp, stank, bad, waifu">
</center>


## Trivia {: #Trivia}
You can play trivia and answer questions with the `/trivia` command.
If you answer a question right, you will be rewarded with a number of <a href="/Items/Collectables#TriviaTrophy" target="_blank">Trivia Trophies</a> based on the question's difficulty. Trivia trophies are non-tradeable, so if a user has them, it means they won the trophies themself.

<center>
<table>
  <th>Question Difficulty</th>
  <th>Amount of Trivia <br> Trophies Rewarded </th>
  <tr>
  <td>Easy</td>
  <td>1</td>
</tr>
...
<img src="/bot-features/games/trivia.png" alt="Trivia example.">
</center>

## Xkcd {: #Xkcd}
Using the `/xkcd` command will show a random comic from <a href="https://xkcd.com" target="_blank">the Xkcd</a>.

<br>
<center>
<img src="/bot-features/misc-fun/xkcd.png" alt="xkcd command">
</center>
