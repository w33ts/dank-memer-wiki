...
<p><img src="/bot-features/advancements/advancements_levels_page_9.png" alt="level rewards page 9" width="300" height="350"> <img src="/bot-features/advancements/advancements_levels_page_10.png" alt="level rewards page 10" width="300" height="350"></p>
<p><img src="/bot-features/advancements/advancements_levels_page_11.png" alt="level rewards page 11" width="300" height="350"> <img src="/bot-features/advancements/advancements_levels_page_12.png" alt="level rewards page 12" width="300" height="350"></p>
<p><img src="/bot-features/advancements/advancements_levels_page_13.png" alt="level rewards page 13" width="300" height="350"> <img src="/bot-features/advancements/advancements_levels_page_14.png" alt="level rewards page 14" width="300" height="350"></p>
<p><img src="/bot-features/advancements/advancements_levels_page_15.png" alt="level rewards page 15" width="300" height="350"> <img src="/bot-features/advancements/advancements_levels_page_16.png" alt="level rewards page 16" width="300" height="350"></p>
<p><img src="/bot-features/advancements/advancements_levels_page_17.png" alt="level rewards page 17" width="300" height="350"> <img src="/bot-features/advancements/advancements_levels_page_18.png" alt="level rewards page 18" width="300" height="350"></p>
<p><img src="/bot-features/advancements/advancements_levels_page_19.png" alt="level rewards page 19" width="300" height="350"></p>
</center>
<br>
...
| Purchase a random skin you still need to obtain. <br> These skins are 10% cheaper than the ones in <br> `/shop view`. The available skin changes daily <br> when the new day starts | 1 | Can purchase each skin once |
| Sacrifice a prestige five pet for an Enchanted  <br> Badosz's Card. You must set your pet as current with `/pets view` before sacrificing it. | 5 | Unlimited |
| Purchase a Prestige Coin for 5,000,000 | 1 | Unlimited |
| Purchase a Coin Voucher for 11,000,000 | 5 | Unlimited |
| Swap 300 Rare Pepe for a Cursed Pepe | 1 | 1 |
| Purchase a Blob Pet for 25x Melmsie's Beard + 10x Voodoo Doll | 1 | 1 |
| Purchase a Jack O' Lantern Pet for 25x Jacky o' Lanty + 10x Spooky Mask | 1 | 1 |
| Purchase a Bean Mp3 Player for 1x Bean + 1x Headphones + 1x Microphone | 2 | 10 |
...
- An XP multiplier (1 +.1xOmega Level)

The requirements for Omega are:
- 100m for Omega level 1, + 100m increase per Omega level
- Prestige 2 for Omega 1, with a +2/+1 alternate increase in prestige needed per Omega level after that (Example: Omega 2 = 4 prestige, Omega 3 = 5 prestige, Omega 4 = 7 prestige, etc.).
...
- An XP multiplier for each prestige (1 + .01xPrestige Level)
...
- Level 35 for Prestige 1, then +35 for each additional Prestige (25 levels per Prestige for Premium Members)
- Pocket balance of 24m coins for Prestige 1, then +24m coins for each additional Prestige level (16m coins per Prestige for Premium Members)
- No inventory net worth is needed anymore
