...
Unfortunately, this command does not have a public loot table available, but you can see user-made list of known crime options and rewards below. Most of the crimes give generic grinding items, but the Tax Evasion option gives the developer item <a href="/Items/Collectables#BadoszsCard" target="_blank">Badosz's Card</a>. 
...
| Crime | Possible Item Rewards |
|:----:|:----:|
| Arson | N/A |
| Bank Robbing | <a href="https://dankmemer.wiki/en/Items/Power-ups#BankNote" target="_blank">Bank Note</a> |
| Boredom | <a href="https://dankmemer.wiki/en/Items/Tools#CellPhone" target="_blank">Cell Phone</a> |
| Cyber Bullying | <a href="https://dankmemer.wiki/en/Items/Tools#CellPhone" target="_blank">Cell Phone</a> |
| Drug Distribution | <a href="https://dankmemer.wiki/en/Items/Collectables#ChillPill" target="_blank">Chill Pill</a> |
| DUI | <a href="https://dankmemer.wiki/en/Items/Power-ups#Alcohol" target="_blank">Alcohol</a>, <a href="https://dankmemer.wiki/en/Items/Power-ups#BottleofWhiskey" target="_blank">Bottle of Whiskey</a> |
| Eating a Hotdog Sideways | <a href="https://dankmemer.wiki/en/Items/Collectables#SanicHotDog" target="_blank">Sanic Hot Dog</a> |
| Fraud | N/A |
| Hacking | <a href="https://dankmemer.wiki/en/Items/Lootboxes#NormieBox" target="_blank">Normie Box</a> |
| Identity Theft | <a href="https://dankmemer.wiki/en/Items/Tools#FakeID" target="_blank">Fake ID</a> | 
| Littering | <a href="https://dankmemer.wiki/en/Items/Sellables#Garbage" target="_blank">Garbage</a> |
| Murder | <a href="https://dankmemer.wiki/en/Items/Power-ups#BankNote" target="_blank">Bank Note</a> |
| Piracy | <a href="https://dankmemer.wiki/en/Items/Tools#Camera" target="_blank">Camera</a>, <a href="https://dankmemer.wiki/en/Items/Tools#Keyboard" target="_blank">Keyboard</a>, <a href="https://dankmemer.wiki/en/Items/Tools#Mouse" target="_blank">Mouse</a> |
| Shoplifting | <a href="https://dankmemer.wiki/en/Items/Tools#CellPhone" target="_blank">Cell Phone</a> | 
| Tax Evasion | <a href="https://dankmemer.wiki/en/Items/Collectables#BadoszsCard" target="_blank">Badosz's Card</a>, <a href="https://dankmemer.wiki/en/Items/Power-ups#BankNote" target="_blank">Bank Note</a> |
| Treason | <a href="https://dankmemer.wiki/en/Items/Collectables#PoliceBadge" target="_blank">Police Badge</a> |
| Trespassing | N/A |
| Vandalism | <a href="https://dankmemer.wiki/en/Items/Tools#Shovel" target="_blank">Shovel</a> |
