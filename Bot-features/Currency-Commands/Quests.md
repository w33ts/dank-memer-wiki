...
# Quests
You can complete daily or weekly quests by grinding different commands on the bot. Each quest has a little reward when you finish it, ranging from coins and items to <a href="/Bot-features/Currency-Commands/Skins" target="_blank">skins</a> and <a href="/Bot-features/Currency-Commands/Multipliers" target="_blank">multipliers</a>. To view your quests, you can use the `/quests` command. 

<center>
  
![quests.png](/bot-features/grinding/quests.png)

</center>

## Daily Quests
Every day there are three daily quests that a user can complete for rewards. The daily quests reset every day at midnight <a href="https://www.timeanddate.com/worldclock/timezone/utc" target="_blank">UTC</a>. 

If you are a <a href="/About-Dank-Memer/Premium-users" target="_blank">premium user</a>, you can reroll all incomplete daily quests for a chance to get alternative quests or rewards. Completed quests can **not** be rerolled.

## Weekly Quests
Every week there are two weekly quests that are the same for all users. The weekly quests reset every Sunday at midnight <a href="https://www.timeanddate.com/worldclock/timezone/utc" target="_blank">UTC</a>.

One of the weekly quests is the same every week and asks you to "Complete 15 Daily Quests." The other weekly quest changes every week.

There is a  <a href="/Bot-features/Currency-Commands/Badges#Quest" target="_blank">quest badge</a> you can unlock for completing a certain number of weekly quests. Unlocking the badge gives you a 15% coin multiplier.
