...
|:------:|:------:|
| `/market accept` | Accept a market offer on the market using the ID of the offer. |
| `/market edit for_coins` | Edit an offer you already posted where you'd be getting coins as payment. |
| `/market edit for_items` | Edit an offer you already posted where you'd be getting items as payment. |
| `/market post for_coins` | Post an offer on the market to sell it for coins as payment. |
| `/market post for_items` | Post an offer on the market to sell it for items as payment. |
| `/market view` | View all the current market offers. You can use the item filter in the dropdown menu to specify what you want to see. |


## Market View
When looking at the `/market view`, you are viewing all offers that have been posted publicly on the market. This view can be filtered by a specific item when you type the command, or the embed itself can be filtered by any combination of the following:
- Buy Offers
- Sell Offers
- Mine (your own offers)
- Offer for Coins (as payment)
- Offer for Items (as payment)
- Expiring Soon
- Posted Recently
