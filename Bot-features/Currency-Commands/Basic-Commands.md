...
You can also use skin fragments to purchase a skin from the `/advancements omega` command. There is one skin available there each day to purchase for a discounted price.
