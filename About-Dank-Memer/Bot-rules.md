...
## Bot Rules
Dank Memer has a set of rules everyone is required to follow if they want to use the bot. This helps users have a good experience and keeps the game fair for everyone. If someone breaks a bot rule, users can receive a ban ranging from a few days to being permanently barred from the bot.
